/*!
 * @file DFRobot_PH.h
 * @brief Arduino library for Gravity: Analog pH Sensor / Meter Kit V2, SKU: SEN0161-V2 (Adapted for ESP32)
 *
...
private:
    ...
    void    phCalibration(byte mode); // calibration process, write key parameters to EEPROM/Preferences
